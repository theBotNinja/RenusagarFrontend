...
export default function Navbar() {
  ...
  return (
    <nav
      className={`${isDark?"bg-gray-950 text-gray-100":"bg-gray-300 text-black"} sticky top-0 z-10 opacity-95 flex items-center justify-between p-4`}
    >
      <div className={`almendra font-extrabold text-3xl `}>Renusagar</div>
